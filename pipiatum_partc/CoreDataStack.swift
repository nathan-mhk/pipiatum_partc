...
//  pipiatum_partc
//
//  Created by Nathan Kong on 20/6/2019.
...
class CoreDataStack {
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "pipiatum_partc", withExtension: "momd")! // type your database name here..
